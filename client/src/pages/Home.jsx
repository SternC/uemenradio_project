    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section 
          ...
          style={{
            backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(https://images.unsplash.com/photo-1585779034823-7e9ac8faec70?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80)'
          }}
        >
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover:-translate-y-2 transition-transform">
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-white p-8 rounded-2xl flex flex-col lg:flex-row justify-between items-center gap-8">
            <div className="flex-1">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">The Underground Vibe</h3>
              <p className="text-lg mb-2">With DJ Nova • 8PM - 12AM</p>
              <p className="text-lg opacity-90">Genre: Indie Electronic / Alternative Rock</p>
            </div>
        ...
        <section className="py-16 px-4 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {shows.map((show, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-red-400">
                <h4 className="text-xl font-bold text-gray-800 mb-2">{show.title}</h4>
        ...
        {/* <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mb-8 text-lg opacity-90">
              Subscribe to our newsletter for the latest show schedules and exclusive content
            </p>
...
const features = [
  {
    ...
    description: "Handpicked tracks from emerging artists and underground scenes"
  },
  {
    icon: "🎤",
    title: "Live DJ Sets",
  ...
  },
  {
    ...
    description: "Crystal clear 320kbps streaming for the best listening experience"
  }
];
